...
$conf['secret_key'] = '51ecdad1-b8a8-4ca7-ac24-23336ea0cec1';
$conf['umask'] = 077;
...
#$conf['auth']['admins'] = array('admin','admin');
#$conf['auth']['admins'] = array('kunal');
$conf['auth']['admins'] = array('megha');
...
$conf['problems']['email'] = 'megha.garg@fosteringlinux.com';
